...
namespace Conference.Common.IocHelper
{
    public interface IObjectContainer
    {
        ...
        /// <param name="serviceName">The service name.</param>
        /// <param name="life">The life cycle of the implementer type.</param>
        void Register<TService, TImplementer>(string serviceName = null, LifeStyle life = LifeStyle.Singleton) where TService : class where TImplementer : class, TService;
        ...
        /// <param name="serviceName">The service name.</param>
        void RegisterInstance<TService, TImplementer>(TImplementer instance, string serviceName = null) where TService : class where TImplementer : class, TService;
    ...
    {
        /// <summary>Represents a component is a transient component.</summary>
        Transient,
        /// <summary>Represents a component is a singleton component.</summary>
        Singleton,
    }
}
