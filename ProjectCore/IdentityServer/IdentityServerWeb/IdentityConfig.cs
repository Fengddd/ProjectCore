        ...
        public static IEnumerable<Client> GetClients()
        {
            ...
            return new List<Client>
            {
                ...
                new Client
                {
                    ...
                    RedirectUris =
                    {
                        "http://localhost:8080/#/IdentityServerCallBack",
                        "http://localhost:8080/#/IdentityServerRefreshToken"
                    },
                    PostLogoutRedirectUris = { "http://localhost:8080/#/IdentityServerClient" },                    
